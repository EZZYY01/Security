    ...
    <div className="flex flex-col min-h-screen">
      <header className="flex items-center justify-between px-6 py-4 bg-white">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold">Strategy For Doctor</span>
        </div>
      ...
      <main className="flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center h-full">
            <div>
              ...
              <p className="text-xl text-white mb-10 text-left">
                Our comprehensive Strategy For Doctor helps you optimize patient care, streamline operations,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 text-left">
                Our Strategy For Doctor provides cutting-edge features to streamline your workflows, improve
        ...
        <Section>
          <h2 className="text-3xl font-bold mb-12 text-center">
            Why Choose Our Strategy For Doctor?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: DollarSign, title: "Cost Savings", description: "Our Strategy For Doctor helps you optimize operations and reduce overhead costs, leading to significant cost savings." },
