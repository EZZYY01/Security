import { Activity, Calendar, ChevronDown, DollarSign, Eye, EyeOff, FileText, Home, Hospital, ShieldCheck, Stethoscope, UserCircle, UserPlus, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-blue-600">
      <header className="bg-white p-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-bold text-xl">Strategy For Doctor</span>
        </div>
